=== Quick Admin Notes ===
Contributors: nejwrks, ajithrn, mbigul, nitkr, sajithv
Tags: admin, notes, dashboard, productivity, reminders
...
1. Upload the `quick-admin-notes` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to your Dashboard to see the "Quick Admin Notes" widget
...
1. Quick Admin Notes widget on the WordPress dashboard
2. Adding a new note card
3. Multiple note cards with different content
